...
<body>
            ...
            <div class="collapse navbar-collapse" id="navcol-1">
                ...
                <form class="form-inline mr-auto" target="_self">
                    <div class="form-group"><label for="search-field"><i class="fa fa-search"></i></label><input class="form-control search-field" type="search" name="search" data-bs-hover-animate="pulse" id="search-field"></div><a class="btn btn-primary" role="button" href="warenkorb.html"
                        style="width:40px;height:40px;margin:0px;padding-top:6px;background-image:url(&quot;assets/img/Warenkorb.png&quot;);background-size:contain;background-repeat:no-repeat;background-color:rgba(255,255,255,0);color:rgb(255,255,255);"></a><a class="btn btn-light action-button"
                        role="button" href="signUp.html" style="background-color:#979c9c;">Sign Up</a>
                    <div class="btn-group"><button class="btn btn-primary" type="button" style="background-color:#348899;border-radius:40px;">Admin</button><button class="btn btn-primary dropdown-toggle dropdown-toggle-split" data-toggle="dropdown" aria-expanded="false" type="button"
                            style="background-color:#348899;border-radius:40px;"></button>
    ...
    <p style="width:100%;height:auto;font-size:40px;color:rgb(255,255,255);">Künstler hinzufügen</p>
                ...
                <div class="col-md-8">
                    ...
                    <div class="form-row">
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group"><label style="color:rgb(255,255,255);">Bandname</label><input class="form-control" type="text" name="firstname" style="border:1px solid #348899;border-radius:40px;"></div>
                        </div>
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group"><label style="color:rgb(255,255,255);">Genre</label><input class="form-control" type="text" name="lastname" style="border:1px solid #348899;border-radius:40px;"></div>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group"><label style="color:rgb(255,255,255);">Tourdatum</label><input class="form-control" type="text" name="firstname" style="border:1px solid #348899;border-radius:40px;"></div>
                        </div>
                        <div class="col-sm-12 col-md-6"><label style="color:rgb(255,255,255);">Mehr daten hinzufügen</label>
                            <div class="form-group"><button class="btn btn-primary" type="button" style="background-color:#348899;border-radius:40px;">+</button></div>
                        </div>
                    </div>
                    <hr>
                    <div class="form-row">
                        <div class="col-md-12 content-right"><button class="btn btn-primary form-btn" type="submit" style="background-color:#348899;border-radius:40px;margin-left:105px;">Künstler hinzufügen</button></div>
                    </div>
                </div>
            </div>
        </form>
