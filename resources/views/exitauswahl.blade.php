    ...
    <div>
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-check" style="margin-top:50px;"><input class="form-check-input" type="checkbox" id="formCheck-1"><label class="form-check-label" for="formCheck-1" style="color:rgb(255,255,255);">Nein</label></div>
                </div>
                <div class="col-md-4">
                    <div class="form-check" style="margin-top:50px;"><input class="form-check-input" type="checkbox" id="formCheck-2"><label class="form-check-label" for="formCheck-2" style="color:rgb(255,255,255);">Ja</label></div>
                </div>
            </div>
        </div>
    </div>
    <div>
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4"></div>
                <div class="col-md-4"><button class="btn btn-primary" type="button" style="border-radius:20px;background-color:#348899;">Weiter</button></div>
            </div>
        </div>
    </div>
