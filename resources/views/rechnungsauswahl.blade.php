...
<p class="lead text-center text-white" style="font-size:2em;  font-family: 'NFLCHARG';font-weight:600;font-size:3em;">RECHNUNGSAUSWAHL</p>
    <div>
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <p style="font-size:16px;color:rgb(255,255,255);margin-top:50px;margin-left:40px;width:196px;">Weicht die Rechnung von der Wohnadresse ab?</p>
                </div>
                <div class="col-md-4">
                    <div class="form-check" style="margin-top:50px;margin-left:0px;padding-left:20px;"><input class="form-check-input" type="checkbox" checked="" id="formCheck-1"><label class="form-check-label" for="formCheck-1" style="color:rgb(255,255,255);margin-left:20px;">Nein</label></div>
                </div>
                <div class="col-md-4">
                    <div class="form-check" style="margin-top:50px;"><input class="form-check-input" type="checkbox" id="formCheck-2"><label class="form-check-label" for="formCheck-2" style="color:rgb(255,255,255);margin-left:20px;">Ja</label></div>
                </div>
            </div>
        </div>
    </div>
    <div>
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4"></div>
                <div class="col-md-4"><a class="btn btn-primary" role="button" href="bezahlmethode.html" style="border-radius:20px;background-color:#348899;">Weiter</a></div>
            </div>
        </div>
    </div>
