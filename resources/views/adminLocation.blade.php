...
<body>
    ...
    <p style="width:100%;height:Auto;font-size:40px;color:rgb(255,255,255);">Location anlegen</p>
    <div>
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group"><label style="color:rgb(255,255,255);">Ort</label><input type="text" style="margin-left:80px;border:1px solid #348899;border-radius:40px;"></div>
                </div>
                <div class="col-md-4">
                    <div class="form-group"><label style="color:rgb(255,255,255);margin-left:-3px;">Straße</label><input type="text" style="margin-left:50px;border:1px solid #348899;border-radius:40px;"></div>
                </div>
                <div class="col-md-4">
                    <div class="form-group"><label style="color:rgb(255,255,255);">Nummer</label><input type="text" style="margin-left:40px;border:1px solid #348899;border-radius:40px;"></div>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-12 col-md-6" style="max-width:33%;">
                    <div class="form-group"><label style="color:rgb(255,255,255);">Block</label><input type="text" name="firstname" style="border:1px solid #348899;border-radius:40px;margin-left:62px;"></div>
                </div>
                <div class="col-sm-12 col-md-6"><label style="color:rgb(255,255,255);">Mehr Blöcke Hinzufügen</label>
                    <div class="form-group"><button class="btn btn-primary" type="button" style="background-color:#348899;border-radius:40px;margin-left:200px;margin-top:-65px;">+</button></div>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-12 col-md-6" style="max-width:33%;">
                    <div class="form-group"><label style="color:rgb(255,255,255);">Reihe</label><input type="text" name="firstname" style="border:1px solid #348899;border-radius:40px;margin-left:62px;"></div>
                </div>
                <div class="col-sm-12 col-md-6"><label style="color:rgb(255,255,255);">Mehr Reihen Hinzufügen</label>
                    <div class="form-group"><button class="btn btn-primary" type="button" style="background-color:#348899;border-radius:40px;margin-left:200px;margin-top:-65px;">+</button></div>
                </div>
                <div class="col-sm-12 col-md-6">
                    <div class="form-group"><label style="color:rgb(255,255,255);">Anzahl Sitze</label><input type="text" name="firstname" style="border:1px solid #348899;border-radius:40px;margin-left:13px;"></div>
                </div>
            </div>
        </div>
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group"><label style="color:rgb(255,255,255);">Postleitzahl</label><input type="text" style="margin-left:17px;font-size:16px;border:1px solid #348899;border-radius:40px;"></div>
                </div>
                <div class="col-md-4">
                    <div class="form-group"><label style="color:rgb(255,255,255);">Land</label><input type="text" style="margin-left:63px;border:1px solid #348899;border-radius:40px;"></div>
                </div>
                <div class="col-md-4">
                    <div class="form-group"><button class="btn btn-primary" type="button" style="background-color:#348899;border-radius:40px;margin-left:105px;">Location anlegen</button></div>
                </div>
            </div>
        </div>
    </div>
