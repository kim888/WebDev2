...
<nav class="navbar navbar-light navbar-expand-md navigation-clean-search" style="background-color:rgba(52,54,66,0);">
    ...
    <p class="lead text-center text-white" style="font-family: 'NFLCHARG';font-weight:600;font-size:3em;">ABWEICHENDE RECHNUNGSADRESSE</p>
    <div class="container profile profile-view" id="profile">
        <form>
            <div class="form-row profile-row">
                <div class="col-md-8">
                    <h3 style="color:rgb(255,255,255);">Rechnung an:</h3>
                    <hr>
                    <div class="form-row">
